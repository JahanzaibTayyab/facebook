...
function Home() {
    ...
    function onPressVideoDetailHandler(videoId) {
        navigation.navigate('WatchDetail', {
            id: videoId
        })
    }
    function onPressPhotoDetailHandler(postId) {
        navigation.navigate('PagePostDetail', {
            postId
        })
    }
    const { page, videos, photos, posts } = props
            ...
            <View style={styles.previewVideoWrapper}>
                ...
                <ScrollView
                    ...
                    {previewVideos.map((video, index) => (
                        <ExTouchableOpacity
                            key={index}
                            onPress={onPressVideoDetailHandler.bind(this, video.id)}
            ...
            <View style={styles.previewVideoWrapper}>
                ...
                <ScrollView
                    ...
                    {previewPhotos.map((photo, index) => (
                        <ExTouchableOpacity
                            key={index}
                            onPress={onPressPhotoDetailHandler.bind(this, photo.id)}
                            style={{
