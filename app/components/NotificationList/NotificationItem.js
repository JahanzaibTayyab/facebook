...
function NotificationItem(props) {
    ...
    function onShowNotificationOptionsHandler(Description) {
        const { item } = props
    ...
    function onPressNotificationHandler() {
        const { item, stories } = props
        const { user } = item
        switch (item.type) {
    ...
    return (
        <View style={{ backgroundColor: "rgba(0,0,0,0.3)" }}>
            <ExTouchableOpacity
                onPress={onPressNotificationHandler.bind(this)}
                onLongPress={onShowNotificationOptionsHandler.bind(this, Description)}
                ...
                <ExTouchableOpacity onPress={onShowNotificationOptionsHandler.bind(this, Description)} style={styles.btnOptions}>
