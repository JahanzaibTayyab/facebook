...
function Item(props) {
    ...
    function onPressGroupNameHandler() {
        const { item } = props
    ...
    function onPressPostImageHandler(id) {
        // const { toggleShowPostDetail } = props
    ...
    const { user, item, isInGroup } = props
    return (
                ...
                <View style={styles.customListView}>
                    ...
                    <View style={styles.infoWrapper}>
                        <View style={styles.namesWrapper}>
                            <ExTouchableOpacity onPress={onPressProfileHandler.bind(this, item.user?.id)}>
                                <Text style={{ fontSize: 16, fontWeight: '500' }}>{item.user?.name}</Text>
                            </ExTouchableOpacity>
                            {!isInGroup && (
                                <>
                                    <Text style={{ fontSize: 16, fontWeight: '500', marginHorizontal: 5 }}>▶</Text>
                                    <TouchableOpacity onPress={onPressGroupNameHandler.bind(this)} style={{ maxWidth: 150 }}>
