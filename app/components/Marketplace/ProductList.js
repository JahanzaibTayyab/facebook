...
function ProductList() {
    ...
    function onPressViewAllHandler() {
    ...
    const { productType, user, products, isInCategory } = props
    ...
    return (
        <View style={styles.container}>
            ...
            {!isInCategory && (
                <ExTouchableOpacity onPress={onPressViewAllHandler.bind(this)} style={styles.btnSeeMore}>
